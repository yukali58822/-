...
def today():
    ...
    now = datetime.now(tz)
    return render_template('templates/today.html',datetime=str(now))
...
def welcome():
    ...
    return render_template('templates/welcome.html',text=user)
...
def query():
    if request.method == "POST":
        ...
        return render_template("templates/ex1.html")
